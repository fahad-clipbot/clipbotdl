...
"""
بوت تليجرام مع نظام الاشتراكات المتكامل
...
from database_models import Database, SubscriptionTier
...
class SubscriptionBot:
    """بوت تليجرام مع نظام الاشتراكات"""
...
/help - المساعدة
    ...
    async def subscribe(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # ترقية الاشتراك
        db.upgrade_subscription(telegram_id, plan_id)
...
شكراً لك على الاشتراك! 🎉
        ...
        logger.info(f"✅ اشتراك جديد: {telegram_id} - {plan_id}")
